...
import {
  Hideable,
  PopUpFormWrapper,
} from "~/components/customComponentsNotFromShadcn/hideableCompoent";
...
const NewSpaceForm: React.FC<{
  onSubmitted: (dataFromForm: { url: string; key: SpaceAuth }) => void;
}> = ({ onSubmitted }) => {
    ...
    <>
      ...
      <input
        ...
        onChange={(e) => {
          setFormState({
            ...formState,
            auth: { ...formState.auth, key: e.target.value },
          });
        }}
      />
      <button
