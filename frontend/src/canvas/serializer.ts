    ...
    state.forEach((canvasObject) => {
      ...
      switch (canvasObject.type) {
        case CursorTypes.Rectangle:
          objectsToReturn[canvasObject.id] = new Rectangle(
            canvasObject.geometricProperties.x,
            canvasObject.geometricProperties.y,
            canvasObject.geometricProperties.width,
            canvasObject.geometricProperties.height,
            canvasObject.id,
            canvasObject.bgColor,
            canvasObject.boundariesColor,
          );
          break;
